...
export const ChapterItem: React.FC<ChapterItemProps> = ({
  ...
  const previousYearCount = previousYear
    ? chapter.yearWiseQuestionCount[previousYear]
    : 0;
  ...
  return (
    <div className="mb-3 mx-4">
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
        className="flex items-center justify-between py-4 px-4 bg-white dark:bg-gray-900 rounded-lg border-0 sm:border sm:border-gray-200 sm:dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors shadow-sm cursor-pointer"
      ...
      >
        <div className="flex items-center flex-1 min-w-0 gap-3">
          ...
          <div className="flex-1 min-w-0">
            <motion.h3
              className="font-medium text-gray-900 dark:text-gray-100 truncate text-[13px]  sm:text-base mb-1 sm:mb-0"
            ...
            {/* Small screen stats */}
            <motion.div
              className="flex items-center gap-1 text-[10px] whitespace-nowrap sm:hidden"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      <div className="flex-shrink-0 flex flex-col-reverse sm:flex-row items-end sm:items-center gap-1 sm:gap-4 text-right">
          <motion.div
      ...
      {/* Chapter Details - Conditionally Rendered */}
